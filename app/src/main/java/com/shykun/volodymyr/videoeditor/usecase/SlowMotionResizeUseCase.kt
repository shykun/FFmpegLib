...
class SlowMotionResizeUseCase(private val videoUri: Uri, context: Context) : BaseUseCase(context) {
    fun execute() {
        FFmpegVideoSlowMotionResize(context, videoUri, object : FFMpegCallback {
